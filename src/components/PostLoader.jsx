...
const ClassicPostLoader = props => {
  ...
  return (
    <ContentLoader viewBox="0 0 800 400" height={375} width={width<500?600:700} {...props}>
      ...
      <rect x="10.47" y="70.52" width="480.36" height="950" rx="4.5" />
      <ellipse cx="27.53" cy="26.15" rx="27.53" ry="26.15" />
      <rect x="69.36" y="35.22" width="87.36" height="16.48" rx="4.5" />
    ...
    <rect x="69.36" y="0.5" width="164.67" height="27.07" rx="3.83" />
    </ContentLoader>
  )
}
